    ...
    with tab3:
        ...
        ref = [
            {"ICD-10": "K29.70", "الوصف": "التهاب المعدة بسبب H. pylori",
             "أكواد CPT المقبولة": "99213, 99214", "ملاحظة": "استخدمه مع Riack Plus / Clarithromycin"},
            {"ICD-10": "K29.7",  "الوصف": "التهاب المعدة غير محدد",
             "أكواد CPT المقبولة": "99213, 99214", "ملاحظة": "لا يبرر وصف المضادات الحيوية وحده"},
            {"ICD-10": "R11",    "الوصف": "غثيان وقيء",
             "أكواد CPT المقبولة": "—", "ملاحظة": "⚠️ عَرَض — لا يُستخدم كتشخيص رئيسي"},
            {"ICD-10": "J18.9",  "الوصف": "التهاب رئوي",
             "أكواد CPT المقبولة": "99213, 99214, 71046", "ملاحظة": "يبرر المضادات الحيوية"},
            ...
            {"ICD-10": "B96.81", "الوصف": "H. pylori كعامل ثانوي",
             "أكواد CPT المقبولة": "—", "ملاحظة": "يُضاف كتشخيص ثانوي لتبرير العلاج الثلاثي"},
        ]
        ...
        tips = [
            ...
            ("ERR-07", "عالي",  "علاج H. pylori بدون كود K29.70",
             "أضف K29.70 أو B96.81 كلما وُصف Riack Plus أو Clarithromycin"),
            ("ERR-08", "عالي",  "مضاد حيوي بدون تشخيص عدوى",
             "تأكد أن التشخيص يبرر المضاد أو أضف الكود الصحيح"),
            ("ERR-01", "عالي",  "عدم تطابق ICD مع CPT",
             "راجع جدول الأكواد في تبويب المرجع"),
            ("ERR-02", "عالي",  "تجاوز الحد المالي بدون موافقة",
